...
def main():
    parser = argparse.ArgumentParser(description='Generate mean style image for AdaIN model')
    parser.add_argument('folder_path', type=str, help='Path to folder containing style images')
    parser.add_argument('--output', type=str, default='mean_style.jpg', help='Path to save output image')
    parser.add_argument('--num_images', type=int, default=5, help='Number of random images to select')
